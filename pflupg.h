...
#define PUBLIC_KEYS_CNT	4 // amount of keys in key array, change this if adding keys
...
#define AUTO_FW_CNT 9 // amount of auto fw in array, change this if adding auto fws
